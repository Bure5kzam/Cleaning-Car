...
class MyApp(QMainWindow): 
    ...
    def pollingQuery(self): 
        self.query = QtSql.QSqlQuery("select * from command_01"); 
        self.text.clear() 
    ...
    def commandQuery(self, cmd, arg): 
        self.query.prepare("insert into command_01 (time, cmd_string, arg_string, is_finish) values (:time, :cmd, :arg, :finish)"); 
